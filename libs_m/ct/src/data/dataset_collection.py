...
class SyntheticDatasetCollection:
    ...
    def process_data_multi(self, include_continuous_treatment=False):
        """
        Used by CT
        """
        self.train_f.process_data(self.train_scaling_params, include_continuous_treatment=include_continuous_treatment)
        if hasattr(self, 'val_f') and self.val_f is not None:
            self.val_f.process_data(self.train_scaling_params, include_continuous_treatment=include_continuous_treatment)
        self.test_cf_one_step.process_data(self.train_scaling_params, include_continuous_treatment=include_continuous_treatment)
        self.test_cf_treatment_seq.process_data(self.train_scaling_params, include_continuous_treatment=include_continuous_treatment)
        self.test_cf_treatment_seq.process_sequential_test(self.projection_horizon, include_continuous_treatment=include_continuous_treatment)
        self.test_cf_treatment_seq.process_sequential_multi(self.projection_horizon, include_continuous_treatment=include_continuous_treatment)
